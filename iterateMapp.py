...
# From: https://stackoverflow.com/questions/229186/os-walk-without-digging-into-directories-below/234329#234329
# -------------------------------------------------------------
def walklevel(some_dir, level):
    some_dir = some_dir.rstrip(os.path.sep)
    assert os.path.isdir(some_dir) #Is it really a directory? IF not AssertionError
